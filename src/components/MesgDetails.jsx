...
const MesgDetails = () => {
  ...
  return (
    <div className='text-center'>
      ...
      {error && <div className='inline-block text-gray-300 text-wrap bg-background font-mono mt-10 p-5 rounded-md'>{error}</div>}
      {mesg && (
        <div className='flex justify-center text-center'>
          <div key={mesg.id} className='bg-background p-8 h-[50vh] w-[40vh] mt-[10vh] rounded-sm shadow-lg text-center border border-outline'>
