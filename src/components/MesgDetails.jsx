...
const MesgDetails = () => {
  ...
  return (
    <div className='text-center'>
      {isLoading && (
        <div className='text-center'>
          <svg aria-hidden='true' className='inline w-8 h-[75vh] mt-5 text-[#191919] animate-spin fill-white' viewBox='0 0 100 101' fill='none' xmlns='http://www.w3.org/2000/svg'>
      ...
      {mesg && (
        <div className='flex justify-center text-center'>
          <div key={mesg.id} className='bg-[#2e2e2e] p-8 h-[50vh] w-[40vh] mt-[10vh] rounded-sm shadow-lg text-center'>
            <h1 className='text-[#dfdfdf] text-4xl font-serif font-[500] flex justify-start'>
              To: {mesg.name} <span className='cursor-pointer pl-2'>✉️</span>
              {/* <span>
